...
export default {
  ...
  methods: {
    fetch() {
      const apiUrl = "https://enigmatic-headland-30994.herokuapp.com";
    ...
    Reserve: function (key) {
      ...
      // const minReservationStart = nextDayTime ? 8 : hh + 1;
      // // const minReservationEnd = nextDayTime ? 9 : hh + 2;

      // if (this.chosenDate === today) {
      //   if (this.chosenStartTime < minReservationStart) {
      //     alert("On peut pas réserver dans le passé :/");
      //     return;
      //   }
      // }
      ...
      console.log(this.chosenEndTime == this.chosenStartTime);
      console.log(this.chosenEndTime, this.chosenStartTime);
      if (this.chosenEndTime === this.chosenStartTime) {
